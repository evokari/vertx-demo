...
public class ConfigLoader {
  ...
  private static final Object CONFIG_FILE = "application.yaml";

  public static Future<PACServiceDefinitionConfig> load(Vertx vertx) {
    ...
    //order of the stores defines which wins (later wins)!
    ...
    return retriever.getConfig().map(PACServiceDefinitionConfig::from);
  }
}
